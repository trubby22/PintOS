...
static void pin_or_unpin_arguments (int syscall_num, void **arg1_ptr, void **arg2_ptr, void **arg3_ptr, pin_or_unpin_obj *pin_or_unpin_obj) {
  ...
  switch (syscall_num) {
    ...
    case SYS_MUNMAP:
      // Pin an int 
      pin_or_unpin_obj(arg1_ptr, sizeof(int *));
      break;
    case SYS_EXEC:
    case SYS_REMOVE:
    case SYS_OPEN:
      ...
      pin_or_unpin_obj(arg1_ptr, sizeof(char *));
      char *char_ptr = (char *) *arg1_ptr;
      pin_or_unpin_obj(char_ptr, MAX_FILENAME_LENGTH + 1);
      break;
  }
  ...
  switch (syscall_num) {
    ...
    case SYS_SEEK:
      // Pin an int 
      pin_or_unpin_obj(arg2_ptr, sizeof(int *));
      break;
  }
  ...
  switch (syscall_num) {
    ...
    case SYS_WRITE:
      // Pin an int 
      pin_or_unpin_obj(arg3_ptr, sizeof(int *));
      int size = *arg3_ptr;
      // Pin char * and individual chars. Length of chars is determined by size.
      pin_or_unpin_obj(arg1_ptr, sizeof(char *));
      char *char_ptr = (char *) *arg1_ptr;
      pin_or_unpin_obj(char_ptr, size + 1);
      break;
  }
}
